...
CustomWeakForm::CustomWeakForm(double Le, double alpha, double beta, double kappa, double x1) : WeakForm<double>(2), Le(Le), alpha(alpha), beta(beta), kappa(kappa), x1(x1)
{
}

void CustomWeakForm::omega_fn(int n, Hermes::vector<double*> values, Hermes::vector<double*> dx, Hermes::vector<double*> dy,
...
void CustomWeakForm::omega_dt_fn(int n, Hermes::vector<double*> values, Hermes::vector<double*> dx, Hermes::vector<double*> dy,
                        double* out, double* outdx, double* outdy)
{
  for (int i = 0; i < n; i++)
  {
...
void CustomWeakForm::omega_dc_fn(int n, Hermes::vector<double*> values, Hermes::vector<double*> dx, Hermes::vector<double*> dy,
                        double* out, double* outdx, double* outdy)
{
  for (int i = 0; i < n; i++)
  {
